 ...
 */
public class Direction extends FragmentActivity implements LocationListener {
    Document document;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String fName = intent.getStringExtra("latitude");
        String lName = intent.getStringExtra("longitude");
    ...
    private class GetRouteTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            Dialog = new ProgressDialog(Direction.this);
